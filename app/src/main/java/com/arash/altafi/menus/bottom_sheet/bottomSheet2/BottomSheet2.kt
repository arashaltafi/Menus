package com.arash.altafi.menus.bottom_sheet.bottomSheet2
...
class BottomSheet2 : AppCompatActivity(), View.OnClickListener, BottomSheetListener {
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        menuInflater.inflate(R.menu.main_bottomsheet2, menu)
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            R.id.share -> {
                ...
                intent.type = "text/*"
                intent.putExtra(Intent.EXTRA_TEXT, "Hey, check out the BottomSheet library https://github.com/arashaltafi/Menus")
    ...
    override fun onSheetShown(bottomSheet: BottomSheetMenuDialogFragment, `object`: Any?) {
        Log.v("BottomSheet2", "onSheetShown with Object " + `object`!!)
    }
    ...
    override fun onSheetDismissed(bottomSheet: BottomSheetMenuDialogFragment, `object`: Any?, dismissEvent: Int) {
        Log.v("BottomSheet2", "onSheetDismissed $dismissEvent")
    }
